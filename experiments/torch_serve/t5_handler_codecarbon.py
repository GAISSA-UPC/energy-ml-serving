...
class T5Handler(BaseHandler):
    ...
    def preprocess(self, data):
        ...
        #input_token = self.tokenizer.encode_plus(sentences, return_tensors = "pt")
    ...
    @track_emissions(project_name = "codet5-base_ts", output_file = RESULTS_DIR + "emissions_codet5-base.csv")
